...
SKILLS = {
    ...
    "AI / Machine Learning": ["Machine Learning", "Scikit-learn", "TensorFlow", "AI", "Prompt Engineering"],
...
def render_skills():
    ...
    section_heading("02 / TOOLKIT", "Skills that <span class='accent'>ship</span>.",
                   "A practical stack for analytics, intelligent applications and data storytelling.")
    cards = []
